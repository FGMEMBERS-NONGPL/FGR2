...
var fuelTanks = func {
	...
	var levelDropStbd = getprop("consumables/fuel/tank[11]/level-gal_us");
		if(levelDropStbd == nil) { levelDropStbd = 0; }
		var levelDropPort = getprop("consumables/fuel/tank[9]/level-gal_us");
		if(levelDropPort == nil) { levelDropPort = 0; }
		var levelDropCentr = getprop("consumables/fuel/tank[10]/level-gal_us");
		if(levelDropCentr == nil) { levelDropCentr = 0; }
		var wingtanks = getprop("sim/weight[0]/weight-lb") + getprop("sim/weight[8]/weight-lb");
